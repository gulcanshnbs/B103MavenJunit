...
public class C01_WindowHandle2 extends TestBase {
    ...
    //IKINCI PENCERE ACILIR VE IKINCI PENCEREDE ISLEM YAPMAK ISTEDIGIMIZI, O PENCEREYI SWITCH-GECIS-YAPMALIYIZ

    switchToWindow(1); //2.windowa gecis yaptik. driver artik 2. windowda
